...
void lcd_display()
{
	...
	Lcd_cursor(&lcd,0,1);
	Lcd_string(&lcd,"L A A K S H I T\n");

	Lcd_cursor(&lcd,1,1);
	Lcd_string(&lcd,"212222230071\n");
	HAL_Delay(2000);
...
![image](https://github.com/laakshit-D/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/119559976/d98d0eb3-c3ac-449f-a729-d70121ab8bc3)
 
### CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 
![image](https://github.com/laakshit-D/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/119559976/f8ae8966-5077-48ae-aa5a-d361a2513ef9)
